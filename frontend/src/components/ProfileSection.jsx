...
const Img = styled.img`
  ...
  border-radius: 50%;
`;
const P = styled.p`color:#F2F3F5`;
const P2 = styled.p`color:#9B9FA5`;
...
export default function ProfileSection({avatar={logo}, name, status})
{
